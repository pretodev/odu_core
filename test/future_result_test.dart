...
void main() {
  ...
  group('FutureResult map', () {
    ...
    test('preserves Err', () async {
      ...
      final result =
          await FutureResultFactory.err<int>(error).map((x) => x * 2);
      expect(result, isA<Err<int>>());
      expect((result as Err<int>).value, equals(error));
    });
  ...
  group('FutureResult mapAsync', () {
    ...
    test('handles async transformation', () async {
      final result = await FutureResultFactory.ok('hello')
  ...
  group('FutureResult flatMapAsync', () {
    ...
    test('can return Err from async transformation', () async {
      final result = await FutureResultFactory.ok(42)
          .flatMapAsync<String>((x) => FutureResultFactory.err(Exception('failed')))
          ;
      expect(result, isA<Err<String>>());
    });
  });
  ...
  group('FutureResult unwrapOr', () {
    ...
    test('returns default on Err', () async {
      final value = await FutureResultFactory.err<int>(Exception('test')).unwrapOr(100);
  ...
  group('FutureResult unwrapOrElse', () {
    ...
    test('computes value from error', () async {
      final value = await FutureResultFactory.err<int>(Exception('test'))
          .unwrapOrElse((e) => 100);
      expect(value, equals(100));
    });
  });
  ...
  group('FutureResult unwrapOrElseAsync', () {
    test('returns Ok value', () async {
      final value = await FutureResultFactory.ok(42).unwrapOrElseAsync((e) async => 100);
      expect(value, equals(42));
    });
  ...
  group('FutureResult isOk and isFail', () {
    ...
    test('isOk returns false for Err', () async {
      expect(await FutureResultFactory.err<int>(Exception('test')).isOk(), isFalse);
    });
    ...
    test('isFail returns true for Err', () async {
      expect(await FutureResultFactory.err<int>(Exception('test')).isFail(), isTrue);
    });
  });
  ...
  group('FutureResult inspect', () {
    ...
    test('does not call inspector on Err', () async {
      var called = false;
      await FutureResultFactory.err<int>(Exception('test'))
  ...
  group('FutureResult inspectErr', () {
    ...
    test('preserves Err', () async {
      final error = Exception('test');
      final result = await FutureResultFactory.err<int>(error).inspectErr((e) {});
      expect(result, isA<Err<int>>());
      expect((result as Err<int>).value, equals(error));
    });
  });
  ...
  group('FutureResult toOption', () {
    ...
    test('converts Err to None', () async {
      final option = await FutureResultFactory.err<int>(Exception('test'))
          .toOption()
          ;
  ...
  group('FutureResult recover', () {
    ...
    test('recovers from Err', () async {
      final result = await FutureResultFactory.err<int>(Exception('test'))
          .recover((e) => 100)
          ;
      expect(result, isA<Ok<int>>());
  ...
  group('FutureResult recoverAsync', () {
    test('preserves Ok', () async {
      final result =
          await FutureResultFactory.ok(42).recoverAsync((e) async => 100);
      expect(result, isA<Ok<int>>());
      expect((result as Ok<int>).value, equals(42));
    });
  ...
  group('FutureResult recoverWith', () {
    test('preserves Ok', () async {
      final result =
          await FutureResultFactory.ok(42).recoverWith((e) => Ok(100));
      expect(result, isA<Ok<int>>());
      expect((result as Ok<int>).value, equals(42));
    });
  ...
  group('FutureResult chaining example', () {
    test('complex chaining scenario', () async {
      ...
      final result = await divide(100, 2)
          .map((x) => x + 10)
          .flatMapAsync((x) => divide(x, 3))
          .recover((e) => 0)
          ;
    ...
    test('error handling in chain', () async {
      ...
      final result = await divide(100, 0)
          .map((x) => x + 10)
          .recover((e) => 999)
          ;
